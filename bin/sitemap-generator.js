...
var SitemapGenerator = /** @class */ (function () {
    function SitemapGenerator(srcDirectory, baseUrl, lastMod) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.findFiles(this.srcDirectory, "index.html")];
                    case 1:
                        files = _a.sent();
    ...
    SitemapGenerator.prototype.addToSitemap = function (file) {
        ...
        this.sitemapContent += "\n    <url>\n        <loc>".concat(url, "</loc>\n        ").concat(this.lastMod ? "<lastmod>".concat(this.lastMod, "</lastmod>") : "", "\n    </url>");
    };
    SitemapGenerator.prototype.writeSitemapToFile = function () {
        var _this = this;
        fs.writeFile(path.join(this.srcDirectory + "sitemap.xml"), this.SITEMAP_HEADER + this.sitemapContent + this.SITEMAP_FOOTER, function (err) {
            if (err) {
                console.log(err.message);
                return;
            }
            console.log("sitemap.xml successfully created in '".concat(_this.srcDirectory, "'"));
        });
    };
